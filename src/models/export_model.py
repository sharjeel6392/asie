...
def export():
    ...
    for model in models:
        ...
        shutil.copytree(model_path, os.path.join(EXPORT_DIR, model['type'], "model"))
        shutil.copytree(tokenizer_path, os.path.join(EXPORT_DIR, model['type'], "tokenizer"))
