...
resource "aws_subnet" "public1" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/asie-cluster" = "shared"
  }
}
...
# S3 Gateway Endpoint — free, and keeps DVC pulls, MLflow artifacts, and
# model downloads off the metered NAT Gateway path entirely.
